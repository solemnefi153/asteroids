 ...
 * DRAW * ASTEROID
 **********************************************************************/
void drawSmallAsteroid( const Point & point,int &angle, int rotation);
void drawMediumAsteroid(const Point & point,int &angle, int rotation);
void drawLargeAsteroid( const Point & point, int &angle, int rotation);
